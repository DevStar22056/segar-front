...
import SimpleModal from '../../../components/invoiceModal';
        ...
        <div className={'over-helper'}>
            ...
            <React.Fragment>
                <Button style={{marginBottom: 5}} variant="text" color="inherit" size="medium">
                    {pulse.text.selected}: <strong
                    style={{marginLeft: 10}}>ID: {elem.id} ( {elem.internal_invoice_number} )</strong>
                </Button>
                {/*<SimpleModal data={elem} />*/}
                <br/>
